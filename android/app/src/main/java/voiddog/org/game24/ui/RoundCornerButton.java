...
import voiddog.org.game24.util.DrawCircleShapeUtil;
...
public class RoundCornerButton extends Button{
     ...
     * 按下时候的背景
     */
    private ShapeDrawable mActiveBg;
    /**
     * 操作不可背景
     */
    ...
    public void setActiveColor(int activeColor){
        mActiveBg.getPaint().setColor(activeColor);
    }
    ...
    void initRootView(AttributeSet attrs, int defStyleAttr){
        ...
        mActiveBg = new ShapeDrawable(new OvalShape());
        ...
        mActiveBg.getPaint().setColor(a.getColor(R.styleable.RoundCornerButton_round_btn_active_bg, mDefaultColor));
        ...
        shapeUtil.setPaintColor(mActiveBg.getPaint().getColor());
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        mActiveBg.setBounds(0, 0, getMeasuredWidth(), getMeasuredHeight());
