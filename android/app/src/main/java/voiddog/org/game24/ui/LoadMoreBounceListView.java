...
public class LoadMoreBounceListView extends BounceListView{
    ...
    void initRoot(){
        ...
        footView.setText(mLoadingText);
        footView.setTextSize(TypedValue.COMPLEX_UNIT_PX,
                getResources().getDimensionPixelSize(R.dimen.rank_list_item_name_size));
        ...
        footView.setTypeface(TypefaceHelper.getInstance().loadTypeface("fonts/jianzhi.TTF"));
